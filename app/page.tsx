  ...
  return (
    <main className="text-center">
      ...
      <section>
        ...
        <div className=' shadow-md rounded-xl text-left my-6 ml-auto mr-auto p-4 max-w-sm bg-slate-100 hover:text-blue-400 md:max-w-xl'>
        ...
        <div className='text-left shadow-md rounded-xl my-6 ml-auto mr-auto p-4 max-w-sm bg-slate-100 hover:text-blue-400 md:max-w-xl'>
        ...
        <div className=' text-left shadow-md rounded-xl my-6 ml-auto mr-auto p-4 bg-slate-100 hover:text-blue-400 max-w-sm md:max-w-xl'>
